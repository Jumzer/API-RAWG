...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"PageList\": () => (/* binding */ PageList)\n/* harmony export */ });\n/* harmony import */ var _PageDetail_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PageDetail.js */ \"./src/js/PageDetail.js\");\nfunction _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== \"undefined\" && o[Symbol.iterator] || o[\"@@iterator\"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === \"number\") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError(\"Invalid attempt to iterate non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it[\"return\"] != null) it[\"return\"](); } finally { if (didErr) throw err; } } }; }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\n\n\nvar PageList = function PageList() {\n  var argument = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : \"\";\n\n  var checkForm = function checkForm() {\n    var form = document.querySelector('#form');\n    form.addEventListener(\"submit\", function (e) {\n      e.preventDefault();\n      var search = document.querySelector('#search').value;\n      window.location.hash = \"#pagelist/\" + search;\n    });\n  };\n\n  checkForm();\n\n  var checkSelect = function checkSelect() {\n    var select = document.querySelector('select');\n    select.addEventListener('change', function (e) {});\n  };\n\n  var preparePage = function preparePage() {\n    var cleanedArgument = argument.replace(/\\s+/g, \"-\");\n    var articles = \"\";\n\n    var fetchList = function fetchList(url, argument) {\n      var finalURL = url;\n\n      if (argument) {\n        finalURL = url + \"&search=\" + argument;\n      }\n\n      fetch(\"\".concat(finalURL)).then(function (response) {\n        return response.json();\n      }).then(function (response) {\n        var _iterator = _createForOfIteratorHelper(response.results),\n            _step;\n\n        try {\n          for (_iterator.s(); !(_step = _iterator.n()).done;) {\n            var article = _step.value;\n            //console.log(article)\n            //console.log(response.results)\n            var arrayPlatforms = \"\";\n\n            var _iterator2 = _createForOfIteratorHelper(article.platforms),\n                _step2;\n\n            try {\n              for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {\n                var platform = _step2.value;\n                arrayPlatforms += platform.platform.name + \" \";\n              }\n            } catch (err) {\n              _iterator2.e(err);\n            } finally {\n              _iterator2.f();\n            }\n\n            var _articles = \"\\n              <div class=\\\"card m-4 card\".concat(article.id, \"\\\">\\n                <img class=\\\"card-img-top\\\" src=\\\"\").concat(article.background_image, \"\\\" alt=\\\"card image\\\">\\n                <div class=\\\"card-body\\\">\\n                  <a href = \\\"#pagedetail/\").concat(article.id, \"\\\" id=\\\"link\\\"><h2>\").concat(article.name, \"</h2></a>\\n                  <h5>\").concat(arrayPlatforms, \"</h5>\\n                </div>\\n              </div>\\n            \");\n\n            document.querySelector(\".page-list .articles\").innerHTML += \"\".concat(_articles); //document.querySelector(`.card${article.id}`).addEventListener(\"click\", (event) => {\n            //window.location.hash=`#pagedetail/ + ${article.id}`\n            //})\n          }\n        } catch (err) {\n          _iterator.e(err);\n        } finally {\n          _iterator.f();\n        }\n      });\n    };\n\n    fetchList(\"https://api.rawg.io/api/games?key=55e1b2a93f3a4ead9645d3c67d42efba\", cleanedArgument);\n  };\n\n  var render = function render() {\n    pageContent.innerHTML = \"\\n      <section class=\\\"page-list\\\">\\n        <div class=\\\"container\\\">\\n          <div class=\\\"articles grille\\\"></div>\\n        </div>\\n      </section>\\n    \";\n    preparePage();\n  };\n\n  render();\n};\n\n\n\n//# sourceURL=webpack://webpack/./src/js/PageList.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack://webpack/./src/sass/style.scss?");
